import { processFiles } from "./Extraction.js";
import {retrieveEmails} from "./Retrieve_emails.js";
import {chat_complete} from "./Chat_System.js";
        ...
        for (const email of emailArray) {
            for (const email2 of emails) {
                ...
                if (trimmedEmail2 === trimmedEmail) {
                    ...
                    const pdfPath = `http://localhost:4000/${relativePdfPath}`; // Adjusted path
...
export const CP = async (req, res) => {
    try {
        ...
        <body>
            <h1>COMPETITIVE PROGRAMMING BACKGROUND</h1>
            <ul>
        `;
